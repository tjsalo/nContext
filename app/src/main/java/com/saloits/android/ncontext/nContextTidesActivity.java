...
/** provides a proof-of-concept implementation that retrieves tide time data from NOAA
 * and displays it.
 *
...
public class nContextTidesActivity extends AppCompatActivity {

    private final String LOG_TAG = nContextTidesActivity.class.getSimpleName();
    private final boolean DEBUG = true;

//    public TideResultReceiver mReceiver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ncontext_tides_activity);
    }


    /* onActivityResult() */

    /** called when another Activity is called, for example to ask the user to enable
     * location tracking.
     *
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            Fragment frg = null;
            frg = getFragmentManager().findFragmentByTag("nContextTidesActivityFragment");
